<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DeleteJob.aspx.cs" Inherits="BootstapADOAssigmentDay57.DeleteJob" %>
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                ...
                                <h4 class="p-3 text-info  bg-dark mt-4">Delete Job Record</h4>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><%= job.expectedSalaryRange %></td>
                                                <%--<td><a href="jobEdit.aspx?id=<%= job.Id %>">Edit</a></td>--%>
                                            <%-- <td><a href="empDelete.aspx?id=<%= emp.Id %>">Delete</a></td>--%>
                                             <td class="text-center"><asp:Button  runat="server" ID="deletebutton" Text="delete" OnClick="ButtonDelete_OnClick"/></td>
